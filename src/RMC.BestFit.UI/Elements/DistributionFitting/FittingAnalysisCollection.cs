...
namespace RMC.BestFit.UI
{
    ...
    /// <summary>
    /// The distribution fitting analysis collection.
    /// </summary>
    /// <remarks>
    /// <para>
    ///     Authors:
    ...
    /// </para>
    /// </remarks>
    public class FittingAnalysisCollection : ElementCollectionBase
    {
        ...
        public FittingAnalysisCollection(IProject parentProject) : base(parentProject) { }

        /// <summary>
        /// The name of the element collection.
        /// </summary>
        public override string Name => "Distribution Fitting Analysis";
        ...
        /// <summary>
        /// Saves all distribution fitting analysis elements in the collection to disk.
        /// </summary>
        /// <remarks>
        ...
        public override void Save()
        {
            ...
            try
            {
                if (_needsTableCompaction)
                {
                    ...
                    {
                        ((FittingAnalysis)ElementList[i]).RaisePreviewSaved(ref cancel);
                        if (cancel == true) return;
                    }
        ...
        /// <summary>
        /// Loads all distribution fitting analysis elements from disk into the collection.
        /// </summary>
        /// <remarks>
        /// This method reads the SQLite database table and creates FittingAnalysis instances for each row found.
        /// </remarks>
        ...
        /// <summary>
        /// Adds a distribution fitting analysis element to the collection.
        /// </summary>
        /// <param name="item">The FittingAnalysis element to add to the collection.</param>
        /// <remarks>
        ...
        /// <summary>
        /// Copies a distribution fitting analysis element from an external project and inserts it into this collection at the specified index.
        /// </summary>
        ...
        /// <remarks>
        /// This operation is not supported for fitting analysis elements and will return without performing any action.
        /// </remarks>
        ...
        /// <summary>
        /// Inserts a distribution fitting analysis element into the collection at the specified index.
        /// </summary>
        /// <param name="index">The zero-based index at which the element should be inserted.</param>
        /// <param name="item">The FittingAnalysis element to insert into the collection.</param>
        /// <remarks>
        /// This method subscribes to property change and deletion events, saves the element to disk if needed, and raises the ElementAdded event.
        /// </remarks>
        ...
        /// <summary>
        /// Deletes the entire distribution fitting analysis collection and removes all associated data from disk.
        /// </summary>
        /// <remarks>
        /// This method permanently removes the collection's database table and all fitting analysis elements it contains.
        /// </remarks>
