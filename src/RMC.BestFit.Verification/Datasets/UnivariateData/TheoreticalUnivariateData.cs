...
namespace RMC.BestFit.Verification.Datasets.UnivariateData
{
    ...
    /// using Weibull plotting positions. Each value is a population quantile on a fixed probability grid.
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// The probabilities are equally spaced; the resulting data values generally are not. A finite
    /// quantile grid is a deterministic calculation fixture, not an independent random sample or
    /// a guarantee that every estimator reproduces the generating parameters exactly.
    /// </para>
    /// <para>
    ...
    {
        /// <summary>
        /// Generates deterministic quantile-grid data from an Exponential distribution using Weibull plotting positions.
        /// </summary>
        ...
        /// <param name="n">The number of Weibull probability-grid ordinates. Default = 1000.</param>
        ...
        /// <summary>
        /// Generates deterministic quantile-grid data from a Gamma distribution using Weibull plotting positions.
        /// </summary>
        /// <param name="alpha">The Numerics scale parameter, retained under the historical name alpha. Default = 5.0.</param>
        /// <param name="beta">The Numerics shape parameter, retained under the historical name beta. Default = 2.0.</param>
        /// <param name="n">The number of Weibull probability-grid ordinates. Default = 1000.</param>
        /// <returns>A tuple containing the DataFrame and the generating parameters [scale, shape].</returns>
        ...
        /// <summary>
        /// Generates deterministic quantile-grid data from a Normal distribution using Weibull plotting positions.
        /// </summary>
        ...
        /// <summary>
        /// Generates deterministic quantile-grid data from a Pearson Type III distribution using Weibull plotting positions.
        /// </summary>
        /// <param name="mu">The mean. Default = 100.0.</param>
        ...
        /// <summary>
        /// Generates deterministic quantile-grid data from a Log-Normal distribution.
        /// </summary>
        ...
        /// <summary>
        /// Generates deterministic quantile-grid data from a Log-Pearson Type III (LP3) distribution.
