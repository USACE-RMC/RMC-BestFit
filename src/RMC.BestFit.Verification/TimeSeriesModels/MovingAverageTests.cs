...
/// <summary>
/// Unit tests for the <see cref="MovingAverage"/> class.
/// Tests moving average (MA) time-series models.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// MA models are useful in hydrology for modeling processes where shocks
/// have finite-duration effects, such as measurement errors or transient disturbances.
/// </para>
/// </remarks>
[TestClass]
public class MovingAverageTests
{
    ...
    /// <summary>
    /// Tests that the data log-likelihood returns MinValue when time series is null.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Tests that the data log-likelihood returns MinValue when parameters contain NaN.
    /// </summary>
    [TestMethod]
