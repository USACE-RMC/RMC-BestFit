...
/// <summary>
/// Unit tests for the <see cref="AutoRegressive"/> class.
/// Tests autoregressive (AR) time-series models.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// AR models are widely used in hydrology for modeling persistence in annual
/// streamflow, flood series, and other environmental time series.
/// </para>
/// </remarks>
[TestClass]
public class AutoRegressiveTests
{
    ...
    private static TimeSeries CreateTrendTimeSeries()
    {
        ...
        for (int i = 0; i < ts.Count; i++)
        {
            ts[i].Value = 100 + i * 2; // Linear trend
        }
        return ts;
    }
    ...
    /// <summary>
    /// Tests that DataLogLikelihood returns double.MinValue when time series is null.
    /// </summary>
    [TestMethod]
    ...
    /// <summary>
    /// Tests that DataLogLikelihood returns double.MinValue when parameters contain NaN.
    /// </summary>
    [TestMethod]
