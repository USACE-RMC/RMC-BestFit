    ...
    private static async Task<QuantileCellDiagnostics> RunQuantileCellExperiment(double gamma, MersenneTwister masterRng)
    {
        ...
        if (validCount == 0)
        {
            return new QuantileCellDiagnostics
            {
                ValidCount = 0,
                MeanQHat = double.NaN,
                RQBCa = double.NaN, Z0Q = double.NaN, AccelQ = double.NaN,
                RQLinkedMVN = double.NaN, RQMVN = double.NaN,
                RLogQBCa = double.NaN, Z0LogQ = double.NaN, AccelLogQ = double.NaN,
                RLogQLinkedMVN = double.NaN, RLogQMVN = double.NaN
            };
        }
