...
public class LinkCalibrationTests
{
    ...
    private static CellDiagnostics RunCellExperiment(double sigma, double gamma, int n, MersenneTwister masterRng)
    {
        ...
        if (validCount == 0)
        {
            ...
            {
                ValidCount = 0,
                MeanMuHat = double.NaN,
                MeanSigmaHat = double.NaN,
                MeanGammaHat = double.NaN,
                RMu = double.NaN,
                Z0Mu = double.NaN,
                AccelMu = double.NaN,
                RSigma = double.NaN,
                RLogSigma = double.NaN,
                Z0Sigma = double.NaN,
                AccelSigma = double.NaN,
                RGamma = double.NaN,
                Z0Gamma = double.NaN,
                AccelGamma = double.NaN,
                BCaLoMu = double.NaN,
                BCaHiMu = double.NaN,
                BCaLoSigma = double.NaN,
                BCaHiSigma = double.NaN,
                BCaLoGamma = double.NaN,
                BCaHiGamma = double.NaN,
                CorrMuSigma = double.NaN,
                CorrMuGamma = double.NaN,
                CorrSigmaGamma = double.NaN,
                BootSdMu = double.NaN,
                BootSdLogSigma = double.NaN,
                BootSdGamma = double.NaN
            };
        }
