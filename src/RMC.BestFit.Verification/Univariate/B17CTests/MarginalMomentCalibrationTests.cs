...
public class MarginalMomentCalibrationTests
{
    ...
    private class CellAccumulator
    {
        ...
        private static AEPDiagnostics AddAEP(AEPDiagnostics a, AEPDiagnostics b) => new()
        {
            ...
            Nu = a.Nu + b.Nu,
            RCohn = a.RCohn + b.RCohn,
            QHat = a.QHat + b.QHat,
            CILow = a.CILow + b.CILow,
            CIHigh = a.CIHigh + b.CIHigh,
            GradMu = a.GradMu + b.GradMu,
            GradSigma = a.GradSigma + b.GradSigma,
            GradGamma = a.GradGamma + b.GradGamma,
            ContribMu = a.ContribMu + b.ContribMu,
            ContribSigma = a.ContribSigma + b.ContribSigma,
            ContribGamma = a.ContribGamma + b.ContribGamma,
            VarQ = a.VarQ + b.VarQ,
            DeltaGamma = a.DeltaGamma + b.DeltaGamma
        };
        ...
        private static AEPDiagnostics DivAEP(AEPDiagnostics a, double c) => new()
        {
            ...
            CIHigh = a.CIHigh / c,
            GradMu = a.GradMu / c,
            GradSigma = a.GradSigma / c,
            GradGamma = a.GradGamma / c,
            ContribMu = a.ContribMu / c,
            ContribSigma = a.ContribSigma / c,
            ContribGamma = a.ContribGamma / c,
            VarQ = a.VarQ / c,
            DeltaGamma = a.DeltaGamma / c
        };
        ...
        {
            RawBootCILo = a.RawBootCILo + b.RawBootCILo,
            RawBootCIHi = a.RawBootCIHi + b.RawBootCIHi,
            BcaCILo = a.BcaCILo + b.BcaCILo,
            BcaCIHi = a.BcaCIHi + b.BcaCIHi,
            BcaZ0Q = a.BcaZ0Q + b.BcaZ0Q,
            BcaAccelQ = a.BcaAccelQ + b.BcaAccelQ
        };
        ...
        {
            RawBootCILo = a.RawBootCILo / c,
            RawBootCIHi = a.RawBootCIHi / c,
            BcaCILo = a.BcaCILo / c,
            BcaCIHi = a.BcaCIHi / c,
            BcaZ0Q = a.BcaZ0Q / c,
            BcaAccelQ = a.BcaAccelQ / c
        };
    }
