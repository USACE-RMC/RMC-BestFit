...
public class GammaLinkCalibrationTests
{
    ...
    private static GammaCellDiagnostics RunCellExperiment(double kappa, MersenneTwister masterRng)
    {
        ...
        if (validCount == 0)
        {
            ...
            {
                ValidCount = 0,
                MeanThetaHat = double.NaN,
                MeanKappaHat = double.NaN,
                RLogTheta = double.NaN,
                Z0Theta = double.NaN,
                AccelTheta = double.NaN,
                RLogKappa = double.NaN,
                Z0Kappa = double.NaN,
                AccelKappa = double.NaN,
                BCaLoTheta = double.NaN,
                BCaHiTheta = double.NaN,
                BCaLoKappa = double.NaN,
                BCaHiKappa = double.NaN
            };
        }
