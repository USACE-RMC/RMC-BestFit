...
| `PointProcessModel`, `PointProcessAnalysis` | Point-process models | Point-process model and analysis | POT unit and verification tests | Complete |
| `MixtureModel`, `MixtureAnalysis` | Mixture models | Mixture model and analysis | Mixture unit tests | Complete |
