...
The published package baseline remains RMC.Numerics 2.1.4 at commit `828664650c9327b309ee8332e707ccca73588e93`. The source checkpoint evaluated with this draft is Numerics commit `90a63a46394db9ef95e72b0fcbba943408110636`. Chapter-specific pins identify the source used to create individual historical fixtures; they do not supersede the report-level source checkpoint.
