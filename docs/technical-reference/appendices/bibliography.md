...
[Technical reference](../index.md) | [Reviewer checklist](reviewer-checklist.md)

This appendix consolidates the page-local reference lists used throughout the technical reference. Chapter-local numeric citations remain local to their chapter; the identifiers below are stable bibliography identifiers generated from DOI or normalized title. Source pages are listed to make citation use auditable.

<a id="b001"></a>
**[B001]** A. A. Balkema and L. de Haan, “Residual life time at great age,” *Annals of Probability*, vol. 2, no. 5, pp. 792–804, 1974.

Used by: [distributions/generalized-pareto.md](../distributions/generalized-pareto.md).

<a id="b002"></a>
**[B002]** A. C. Davison and R. L. Smith, “Models for exceedances over high thresholds,” *Journal of the Royal Statistical Society: Series B*, vol. 52, no. 3, pp. 393–442, 1990.

Used by: [distributions/point-process.md](../distributions/point-process.md).

<a id="b003"></a>
**[B003]** A.-C. Favre, S. Quessy, and M. H. T. T. Nguyen, “Multivariate hydrological frequency analysis using copulas,” *Water Resour. Res.*, vol. 40, W01101, 2004, doi: 10.1029/2003WR002456.

Used by: [analysis/bivariate.md](../analysis/bivariate.md), [analysis/coincident-frequency.md](../analysis/coincident-frequency.md).

<a id="b004"></a>
**[B004]** A. Gelman and D. B. Rubin, “Inference from iterative simulation using multiple sequences,” *Statistical Science*, vol. 7, no. 4, pp. 457–472, 1992.

Used by: [estimation/diagnostics.md](../estimation/diagnostics.md).

<a id="b005"></a>
**[B005]** A. Gelman, J. B. Carlin, H. S. Stern, D. B. Dunson, A. Vehtari, and D. B. Rubin, *Bayesian Data Analysis*, 3rd ed. Boca Raton, FL, USA: CRC Press, 2013.

Used by: [analysis/overview.md](../analysis/overview.md), [analysis/univariate.md](../analysis/univariate.md), [distributions/univariate.md](../distributions/univariate.md), [estimation/maximum-a-posteriori.md](../estimation/maximum-a-posteriori.md), [models/overview.md](../models/overview.md).

<a id="b006"></a>
**[B006]** A. Gelman, X.-L. Meng, and H. Stern, “Posterior predictive assessment of model fitness via realized discrepancies,” *Statistica Sinica*, vol. 6, pp. 733–760, 1996.

Used by: [estimation/predictive-checks.md](../estimation/predictive-checks.md).

<a id="b007"></a>
**[B007]** A. Hall, *Generalized Method of Moments*. Oxford University Press, 2005.

Used by: [estimation/generalized-method-of-moments.md](../estimation/generalized-method-of-moments.md).

<a id="b008"></a>
**[B008]** A. P. Dempster, N. M. Laird, and D. B. Rubin, “Maximum likelihood from incomplete data via the EM algorithm,” *Journal of the Royal Statistical Society: Series B*, vol. 39, no. 1, pp. 1–38, 1977.

Used by: [distributions/mixture.md](../distributions/mixture.md).

<a id="b009"></a>
**[B009]** A. Sklar, “Fonctions de répartition à n dimensions et leurs marges,” *Publ. Inst. Statist. Univ. Paris*, vol. 8, pp. 229–231, 1959.
...
<a id="b043"></a>
**[B043]** J. Le Coz, B. Renard, L. Bonnifait, F. Branger, and R. Le Boursicaud, “Combining hydraulic knowledge and uncertain gaugings in the estimation of hydrometric rating curves: A Bayesian approach,” *J. Hydrol.*, vol. 509, pp. 573–587, 2014.

Used by: [analysis/rating-curve.md](../analysis/rating-curve.md).

<a id="b044"></a>
**[B044]** J. M. Flegal, M. Haran, and G. L. Jones, “Markov chain Monte Carlo: can we trust the third significant figure?” *Statistical Science*, vol. 23, no. 2, pp. 250–260, 2008.

Used by: [estimation/diagnostics.md](../estimation/diagnostics.md).

<a id="b045"></a>
**[B045]** J. Pickands III, “Statistical inference using extreme order statistics,” *Annals of Statistics*, vol. 3, no. 1, pp. 119–131, 1975.

Used by: [distributions/generalized-pareto.md](../distributions/generalized-pareto.md).

<a id="b046"></a>
**[B046]** J. R. M. Hosking and J. R. Wallis, *Regional Frequency Analysis: An Approach Based on L-Moments*. Cambridge University Press, 1997.

Used by: [distributions/generalized-extreme-value.md](../distributions/generalized-extreme-value.md), [distributions/generalized-logistic.md](../distributions/generalized-logistic.md), [distributions/generalized-normal.md](../distributions/generalized-normal.md), [distributions/kappa-four.md](../distributions/kappa-four.md).

<a id="b047"></a>
**[B047]** J. R. M. Hosking, “The four-parameter kappa distribution,” *IBM Journal of Research and Development*, vol. 38, no. 3, pp. 251–258, 1994.

Used by: [distributions/kappa-four.md](../distributions/kappa-four.md).

<a id="b048"></a>
**[B048]** J. R. Stedinger and T. A. Cohn, "Flood frequency analysis with historical and paleoflood information," *Water Resources Research*, vol. 22, no. 5, pp. 785-793, 1986. doi: 10.1029/WR022i005p00785.

Used by: [data-frame/index.md](../data-frame/index.md).

<a id="b049"></a>
**[B049]** J. Salvadori, C. De Michele, N. T. Kottegoda, and R. Rosso, *Extremes in Nature: An Approach Using Copulas*. Dordrecht, The Netherlands: Springer, 2007.

Used by: [distributions/competing-risks.md](../distributions/competing-risks.md).

<a id="b050"></a>
**[B050]** K. P. Burnham and D. R. Anderson, *Model Selection and Multimodel Inference*, 2nd ed. New York, NY, USA: Springer, 2002.

Used by: [analysis/distribution-fitting.md](../analysis/distribution-fitting.md), [distributions/composite.md](../distributions/composite.md).

<a id="b051"></a>
**[B051]** K. Pearson, “Contributions to the mathematical theory of evolution. II. Skew variation in homogeneous material,” *Philosophical Transactions of the Royal Society A*, vol. 186, pp. 343–414, 1895.

Used by: [distributions/pearson-type-iii.md](../distributions/pearson-type-iii.md).

<a id="b052"></a>
**[B052]** L. P. Hansen, “Large sample properties of generalized method of moments estimators,” *Econometrica*, vol. 50, no. 4, pp. 1029–1054, 1982.
...
<a id="b053"></a>
**[B053]** L. Tierney and J. B. Kadane, “Accurate approximations for posterior moments and marginal densities,” *Journal of the American Statistical Association*, vol. 81, no. 393, pp. 82–86, 1986.
...
<a id="b064"></a>
**[B064]** R. B. Nelsen, *An Introduction to Copulas*, 2nd ed. New York, NY, USA: Springer, 2006.

Used by: [analysis/bivariate.md](../analysis/bivariate.md), [analysis/coincident-frequency.md](../analysis/coincident-frequency.md).

<a id="b065"></a>
**[B065]** R. D. Cook, “Detection of influential observation in linear regression,” *Technometrics*, vol. 19, no. 1, pp. 15–18, 1977.

Used by: [estimation/diagnostics.md](../estimation/diagnostics.md), [estimation/influence-diagnostics.md](../estimation/influence-diagnostics.md).

<a id="b066"></a>
**[B066]** R. H. Shumway and D. S. Stoffer, *Time Series Analysis and Its Applications*, 4th ed., Springer, 2017.

Used by: [analysis/arimax.md](../analysis/arimax.md), [analysis/time-series.md](../analysis/time-series.md).

<a id="b067"></a>
**[B067]** R. J. Hyndman and G. Athanasopoulos, *Forecasting: Principles and Practice*, 3rd ed., OTexts, 2021.

Used by: [analysis/arima.md](../analysis/arima.md), [analysis/arimax.md](../analysis/arimax.md), [analysis/time-series.md](../analysis/time-series.md).

<a id="b068"></a>
**[B068]** S. A. Padoan, M. Ribatet, and S. A. Sisson, “Likelihood-based inference for max-stable processes,” *Journal of the American Statistical Association*, vol. 105, no. 489, pp. 263–277, 2010, doi: 10.1198/jasa.2009.tm08577.

Used by: [spatial/spatial-extremes.md](../spatial/spatial-extremes.md).

<a id="b069"></a>
**[B069]** S.-C. Kao and R. S. Govindaraju, “Probabilistic structure of storm surface runoff considering the dependence between average intensity and storm duration of rainfall events,” *Water Resour. Res.*, vol. 43, W06410, 2007, doi: 10.1029/2006WR005564.

Used by: [analysis/coincident-frequency.md](../analysis/coincident-frequency.md).

<a id="b070"></a>
**[B070]** S. Chatterjee and A. S. Hadi, “Influential observations, high leverage points, and outliers in linear regression,” *Statistical Science*, vol. 1, no. 3, pp. 379–393, 1986.
...
<a id="b077"></a>
**[B077]** T. A. Cohn, W. L. Lane, and J. R. Stedinger, “Confidence intervals for Expected Moments Algorithm flood quantile estimates,” *Water Resources Research*, vol. 37, no. 6, pp. 1695–1706, 2001.

Used by: [analysis/bulletin-17c-uncertainty.md](../analysis/bulletin-17c-uncertainty.md), [analysis/bulletin-17c.md](../analysis/bulletin-17c.md).

<a id="b078"></a>
**[B078]** T. A. Cohn, W. L. Lane, and W. G. Baier, “An algorithm for computing moments-based flood quantile estimates when historical flood information is available,” *Water Resources Research*, vol. 33, no. 9, pp. 2089–2096, 1997.

Used by: [analysis/bulletin-17c-estimation.md](../analysis/bulletin-17c-estimation.md), [analysis/bulletin-17c.md](../analysis/bulletin-17c.md), [distributions/log-pearson-type-iii.md](../distributions/log-pearson-type-iii.md).

<a id="b079"></a>
**[B079]** T. Bayes, “An essay towards solving a problem in the doctrine of chances,” *Philosophical Transactions of the Royal Society of London*, vol. 53, pp. 370–418, 1763.

Used by: [estimation/maximum-a-posteriori.md](../estimation/maximum-a-posteriori.md).

<a id="b080"></a>
**[B080]** T. J. DiCiccio and B. Efron, “Bootstrap confidence intervals,” *Statistical Science*, vol. 11, no. 3, pp. 189–228, 1996.
