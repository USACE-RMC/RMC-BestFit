...
| Spatial GEV | Correlation, cached MVN, error model, observed-subset copula, data/prior identity, row/year criteria, Godambe-status, reduced-model, fold-accounting, result DTO, and compiled workflow tests | R `mvtnorm` missing-site and location-error likelihood oracle (8 cells), guarded row/year criteria cell, 3 leave-one-site-out parity/accounting cells, 9 recovery cells | TR-048, TR-049, TR-055, and TR-057 closed (Batch 6.3); TR-050 through TR-053 closed (Batch 6.4, 22 August 2026); TR-054, TR-056, and TR-058 through TR-062 open |
