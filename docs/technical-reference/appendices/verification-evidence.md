...
| Spatial GEV | Correlation, cached MVN, error model, observed-subset copula, data/prior identity, row/year criteria, Godambe-status, reduced/resampled-model, fold-accounting, prediction, regional-posterior, dispatch, simulation, result DTO, and compiled workflow tests | R `mvtnorm` missing-site and location-error likelihood oracle (8 cells), R conditional-GP kriging oracle (15 cases), guarded criteria, leave-one-site-out (3), prediction/regional (2), simulation (1), and dispatch (3) cells, 9 recovery cells | TR-048 through TR-058, TR-061, TR-062, TR-091 through TR-093 closed (Batches 6.3-6.5, 21-22 August 2026); TR-059 and TR-060 open |
