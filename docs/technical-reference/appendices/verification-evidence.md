...
| Competing risks | Fixed composition, validation, and lifecycle tests | Dependence-aware simulation evidence remains to be added | TR-012 open for the remaining Phase 4 batch |
