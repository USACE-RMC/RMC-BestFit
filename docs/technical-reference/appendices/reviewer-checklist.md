...
| Competing risks | [Competing-risks chapter](../distributions/competing-risks.md) | min/max CDF/PDF under selected dependence | `competing-risks-workflow` | Fixed composition tests; TR-012 open |
