...
| `CompetingRiskAnalysis` | `CompetingRisksModel` | MLE recovery and predictive checks | Use exactly N=1000 for every design; resolve or document all Bayesian maximum/correlated designs using identified response quantities |
