...
| VC-012: seven copula families reproduce independent pseudo-likelihood and IFM optima, with accepted bivariate/CFA recovery | `report/bivariate-analyses.md` | Independent Python copula oracle and seeded recovery | `CopulaEstimationOracleTests`; `RecoverNormalCopulaParameters`; `SumOfNormals_RhoZero_MatchesClosedForm` | Statistical likelihood-region and recovery gates; 25/25 reported cells pass |
