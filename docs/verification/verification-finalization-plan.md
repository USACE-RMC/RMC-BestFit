...
- The review-finding register contains summary rows and detailed sections for TR-001 through TR-091; TR-066 through TR-083 record the 21 August 2026 post-closure corrections, TR-084 through TR-090 hold the open decision items worked after Phase 6, and TR-091 records the spatial clone defect found and fixed in Batch 6.3.
...
Decisions recorded on 22 August 2026 (Haden Smith): TR-091 clone fix approved; TR-050/TR-051 approved as proposed (reduced training models with fold analyses, no restoration refit); TR-052 approved with the throw on missing covariates; TR-053 approved with status, NaN metrics, and counts, throwing only when no fold succeeds.
