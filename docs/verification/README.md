...
| Time-series models | Phase 5 in progress | UI/App API and legacy XML compatibility guardrails pass; TR-035 through TR-041 and TR-046 remain in the approved implementation sequence. See [Time-Series Verification](time-series.md). |
