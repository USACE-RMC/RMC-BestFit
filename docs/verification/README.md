...
| Time-series models | Phase 5 in progress; TR-035 closed | UI/App API and legacy XML compatibility guardrails pass. Jeffreys metadata passes fast decomposition regressions and an exact analytical oracle; TR-036 through TR-041 and TR-046 remain in sequence. See [Time-Series Verification](time-series.md). |
